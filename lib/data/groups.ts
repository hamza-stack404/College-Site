...
export const intermediateGroupsData: IntermediateGroup[] = [
  {
    ...
    subjectsPart1: [
      { name: "Biology (Part-I)", code: "BIO-1", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Cell Biology, biological molecules, enzymes, bioenergetics, and taxonomy." },
      { name: "Chemistry (Part-I)", code: "CHM-1", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Physical and inorganic chemistry, atomic structure, and chemical equilibrium." },
      { name: "Physics (Part-I)", code: "PHY-1", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Mechanics, waves, circular motion, optics, and thermodynamics." },
    ...
    subjectsPart2: [
      { name: "Biology (Part-II)", code: "BIO-2", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Human physiology, homeostasis, coordination, genetics, and biotechnology." },
      { name: "Chemistry (Part-II)", code: "CHM-2", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Organic synthesis, functional groups, hydrocarbons, and applied chemistry." },
      { name: "Physics (Part-II)", code: "PHY-2", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Electromagnetism, alternating currents, modern physics, and nuclear physics." },
  ...
  },
  {
    ...
    subjectsPart1: [
      ...
      { name: "Physics (Part-I)", code: "PHY-1", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Mechanics, vectors, work and energy, oscillations, and heat." },
      { name: "Chemistry (Part-I)", code: "CHM-1", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Atomic structure, chemical bonding, gases, solids, and thermochemistry." },
    ...
    subjectsPart2: [
      ...
      { name: "Physics (Part-II)", code: "PHY-2", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Electromagnetism, electronics, atomic spectra, and nuclear physics." },
      { name: "Chemistry (Part-II)", code: "CHM-2", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Inorganic periodicity, organic synthesis, and industrial chemistry." },
  ...
  },
  {
    ...
    subjectsPart1: [
      { name: "Computer Science (Part-I)", code: "CSC-1", theoryMarks: 75, practicalMarks: 25, totalMarks: 100, description: "Basics of IT, computer networks, architecture, and applications." },
      ...
      { name: "Physics (Part-I) / Statistics", code: "PHY-1 / STAT-1", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Mechanics and thermodynamics OR statistical methods." },
    ...
    subjectsPart2: [
      { name: "Computer Science (Part-II)", code: "CSC-2", theoryMarks: 75, practicalMarks: 25, totalMarks: 100, description: "C / C++ programming, arrays, pointers, functions, and MS Access database." },
      ...
      { name: "Physics (Part-II) / Statistics", code: "PHY-2 / STAT-2", theoryMarks: 85, practicalMarks: 15, totalMarks: 100, description: "Electromagnetism and electronics OR statistical inference." },
      { name: "English (Compulsory Part-II)", code: "ENG-2", theoryMarks: 100, totalMarks: 100, description: "Essay writing, novel study, and translation." },
